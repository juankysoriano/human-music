...
export const noteOn = (instrument: number, note: number, velocity: number) => MIDI.noteOn(instrument, note, velocity + randomNumber(-5, 5), randomNumber(0, 0.025))

export const chordOn = (instrument: number, chord: number[], velocity: number) => MIDI.chordOn(instrument, chord, velocity + randomNumber(-5, 5), randomNumber(0, 0.025))
